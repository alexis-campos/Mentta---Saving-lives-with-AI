            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative">
                    <button id="alerts-button" class="relative p-2 text-gray-600 hover:text-red-600 transition-colors">
                        ...
                        <span id="alert-badge"
                            class="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold hidden">0</span>
                    </button>
                </div>
        ...
        <aside id="sidebar" class="w-80 bg-white border-r overflow-y-auto flex-shrink-0">
            <div class="p-4">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <button id="refresh-patients" class="text-gray-400 hover:text-blue-600 transition-colors"
                        title="Actualizar">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50">
            <div id="patient-detail" class="p-6">
                ...
                <div id="patient-info" class="hidden">
                    ...
                    <div class="bg-white rounded-xl p-6 mb-6 shadow-sm border">
                        <div class="flex items-start justify-between">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 class="text-2xl font-bold text-gray-800" id="patient-name-detail">Nombre del
                                        Paciente</h2>
                        ...
                        <div class="bg-white rounded-xl p-5 shadow-sm border">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-2xl font-bold text-gray-800" id="metric-streak">0 <span
                                            class="text-sm font-normal">días</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 mb-6 shadow-sm border">
                        <h3 class="text-lg font-semibold text-gray-800 mb-4">📊 Evolución Emocional (Últimos 30 días)
                        </h3>
                        <div class="h-64">
