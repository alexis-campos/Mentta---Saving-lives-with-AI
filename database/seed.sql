...
-- USUARIOS: Psicólogos
-- ============================================
INSERT INTO users (email, password_hash, name, age, role, language) VALUES
('psicologo1@mentta.com', '$2y$10$HRkTOJLT75dOsYUkWIQRdesgaqTN25B.M6fhmUX5Ez76a6Qk9DqPq', 'Dra. María Rodríguez', 38, 'psychologist', 'es'),
('psicologo2@mentta.com', '$2y$10$HRkTOJLT75dOsYUkWIQRdesgaqTN25B.M6fhmUX5Ez76a6Qk9DqPq', 'Dr. Carlos Méndez', 45, 'psychologist', 'es');

-- ============================================
-- USUARIOS: Pacientes
-- ============================================
INSERT INTO users (email, password_hash, name, age, role, language) VALUES
('paciente1@mentta.com', '$2y$10$HRkTOJLT75dOsYUkWIQRdesgaqTN25B.M6fhmUX5Ez76a6Qk9DqPq', 'Ana García', 24, 'patient', 'es'),
('paciente2@mentta.com', '$2y$10$HRkTOJLT75dOsYUkWIQRdesgaqTN25B.M6fhmUX5Ez76a6Qk9DqPq', 'Pedro López', 30, 'patient', 'es'),
('paciente3@mentta.com', '$2y$10$HRkTOJLT75dOsYUkWIQRdesgaqTN25B.M6fhmUX5Ez76a6Qk9DqPq', 'Laura Torres', 22, 'patient', 'es'),
('paciente4@mentta.com', '$2y$10$HRkTOJLT75dOsYUkWIQRdesgaqTN25B.M6fhmUX5Ez76a6Qk9DqPq', 'Miguel Ríos', 28, 'patient', 'es'),
('paciente5@mentta.com', '$2y$10$HRkTOJLT75dOsYUkWIQRdesgaqTN25B.M6fhmUX5Ez76a6Qk9DqPq', 'Sofía Ramos', 26, 'patient', 'es');

-- ============================================
-- ENLACES PACIENTE-PSICÓLOGO
-- Pacientes 1, 2, 3 con Dra. María (id=1)
-- Pacientes 4, 5 con Dr. Carlos (id=2)
-- ============================================
INSERT INTO patient_psychologist_link (patient_id, psychologist_id, status, notes) VALUES
...
-- Simulan información extraída de conversaciones
-- ============================================

-- Ana García (id=3)
INSERT INTO patient_memory (patient_id, memory_type, key_name, value, context, importance) VALUES
...
-- Variadas por paciente con diferentes sentimientos
-- ============================================

-- Ana García (id=3) - Conversaciones sobre ansiedad laboral
INSERT INTO conversations (patient_id, message, sender, sentiment_score, risk_level, created_at) VALUES
...
-- Conversación posterior más positiva
...
-- Pedro López (id=4) - Conversaciones sobre desempleo y depresión
INSERT INTO conversations (patient_id, message, sender, sentiment_score, risk_level, created_at) VALUES
...
-- Laura Torres (id=5) - Conversaciones sobre estrés académico
INSERT INTO conversations (patient_id, message, sender, sentiment_score, risk_level, created_at) VALUES
...
-- Miguel Ríos (id=6) - Conversaciones sobre ataques de pánico
INSERT INTO conversations (patient_id, message, sender, sentiment_score, risk_level, created_at) VALUES
...
-- Sofía Ramos (id=7) - Conversaciones sobre duelo
INSERT INTO conversations (patient_id, message, sender, sentiment_score, risk_level, created_at) VALUES
...
-- ALERTAS HISTÓRICAS
-- ============================================
INSERT INTO alerts (patient_id, psychologist_id, alert_type, severity, message_snapshot, ai_analysis, status, resolution_notes, created_at, acknowledged_at, resolved_at) VALUES
-- Alerta resuelta de Pedro
...
-- Alerta histórica falsa positiva
...
-- Ana García (id=3)
INSERT INTO emergency_contacts (patient_id, contact_name, contact_phone, contact_relationship, priority, is_verified, notes) VALUES
